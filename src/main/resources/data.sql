...
-- INSERT INTO users (id, fullName, role) VALUES (5, 'Nick', 'USER');
-- INSERT INTO users (id, fullName, role) VALUES (6, 'Nora', 'MANAGER');
-- INSERT INTO users (id, fullName, role) VALUES (4, 'Mike', 'USER');

INSERT INTO rooms (id, room_number, price, is_available, hotel_id) VALUES (1,123, 500, false, 4);
INSERT INTO rooms (id, room_number, price, is_available, hotel_id) VALUES (2, 43, 100, false, 5);
INSERT INTO rooms (id, room_number, price, is_available, hotel_id) VALUES (3, 234, 250, false, 6);
INSERT INTO rooms (id, room_number, price, is_available, hotel_id) VALUES (4, 231, 150, true, null);
INSERT INTO rooms (id, room_number, price, is_available, hotel_id) VALUES (5, 6456, 450, true, null);
INSERT INTO rooms (id, room_number, price, is_available, hotel_id) VALUES (6, 1234, 500,true, null);
